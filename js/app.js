...
function agregarEstudiante() {
    ...
    var habSocio = prompt("Porcentaje Habilidades Socio-Emocionales:");
...
function mostrar(estudiante) {
    ...
    resultado += "<p><strong>Puntos HSE:</strong> " + estudiante.habSocio + "</p>";
    resultado += "</div>";
    resultado += "</div>";
    resultado += "</div>";
    resultado += "</div>";
...
function mostrarLista(estudiantes) {
  ...
  var resultado = " ";
  var listaEstudiantes = estudiantes.forEach(function(estudiante){
